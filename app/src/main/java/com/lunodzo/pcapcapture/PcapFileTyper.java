...
public class PcapFileTyper extends FilelistFragment.FileTyper {
	...
	public FilelistFragment.FileEntry getEntry(File directory, String fn) {
		...
		*/
		...
		FilelistFragment.FileEntry f = new FilelistFragment.FileEntry(directory, fn,
	...
	@Override
	public void updateDetailsView(final TextView v, final FilelistFragment.FileEntry fe) {
		v.post(new Runnable() {
			public void run() {
				String pcapdetails = "No pcap data";
				int npackets = 0;
